                        ...
                        <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
                            ...
                            <div x-data="{ isActive: true, open: false, openProcessed: false, }">
                                ...
                                <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Components">
                                    ...
                                    <a  @click="$event.preventDefault(); openProcessed = !openProcessed"
                                        role="menuitem"
                                        ...
                                        <span aria-hidden="true" class="ml-auto">
                                            <!-- active class 'rotate-180' -->
                                            <svg class="w-4 h-4 transition-transform transform" :class="{ 'rotate-180': openProcessed }"
                                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M19 9l-7 7-7-7" />
                                    ...
                                    <div  x-show="openProcessed"
                                    class="mt-2 space-y-2 px-7" role="menu" arial-label="Components">
                    ...
                    <header class="relative bg-white dark:bg-darker">
                        <div class="flex items-center justify-between p-2 border-b dark:border-blue-800">
                            ...
                            <div class="flex ml-4 sm:flex-wrap sm:ml-0">
                                <img src="{{ asset('images/logo.jpeg') }}" class="w-8 h-8 mt-2 rounded-full lg:w-12 lg:h-12 sm:mt-0"
                                    alt="Mrkuku logo">
                                    <a href="#"
