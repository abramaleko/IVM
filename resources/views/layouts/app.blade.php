...
<body>
    <div x-data="setup()" x-init="$refs.loading.classList.add('hidden');" :class="{ 'dark': isDark}">
        ...
        <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
            <!-- Loading screen -->
            <div x-ref="loading"
                class="fixed inset-0 z-50 flex items-center justify-center text-2xl font-semibold text-white bg-blue-800 bg-opacity-90">
                Loading.....
            </div>
            ...
            <aside class="flex-shrink-0 hidden w-64 bg-white border-r dark:border-blue-800 dark:bg-darker md:block">
                <div class="flex flex-col h-full">
                    ...
                    <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
                        ...
                        <!-- Components links -->
                        <div x-data="{ isActive: true, open: false, openProcessed: false, }">
                            ...
                            <a href="#" @click="$event.preventDefault(); open = !open"
                                ...
                                <span class="ml-2 text-base"> Invoices </span>
                            ...
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Components">
                                ...
                                <a href="{{ route('new-invoice') }}" role="menuitem"
                                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md cursor-pointer dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                                    New Request
                                </a>
                                ...
                                <a @click="$event.preventDefault(); openProcessed = !openProcessed" role="menuitem"
                                    class="flex items-center p-2 text-sm text-gray-400 transition-colors rounded-md cursor-pointer dark:hover:text-light hover:text-gray-700">

                                    Processed Invoices
                                    <span aria-hidden="true" class="ml-auto">
                                        <!-- active class 'rotate-180' -->
                                        <svg class="w-4 h-4 transition-transform transform"
                                            :class="{ 'rotate-180': openProcessed }" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div x-show="openProcessed" class="mt-2 space-y-2 px-7" role="menu"
                                    arial-label="Components">

                                    <a href="{{ route('rearing-project') }}" role="menuitem"
                                        class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md cursor-pointer dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                                        Chicken Rearing Project
                                    </a>

                                    <a href="{{ route('corn-project') }}" role="menuitem"
                                        class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md cursor-pointer dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                    ...
                    <!-- Sidebar footer -->
                    <p class="my-4 text-xs text-center text-gray-600 dark:text-light">
            ...
            <div class="flex flex-col flex-1 min-h-screen overflow-x-hidden overflow-y-auto">
                ...
                <header class="relative bg-white dark:bg-darker">
                    <div class="flex items-center justify-between p-2 border-b dark:border-blue-800">
                        ...
                        <!-- Brand -->
                        <div class="flex ml-4 sm:flex-wrap sm:ml-0">
                            <img src="{{ asset('images/logo.jpeg') }}"
                                class="w-8 h-8 mt-2 rounded-full lg:w-12 lg:h-12 sm:mt-0" alt="Mrkuku logo">
                            <a href="#"
                                class="inline-block ml-4 text-base font-semibold tracking-tight text-blue-700 uppercase sm:mt-2 sm:text-xl dark:text-light">
                        ...
                        <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                            ...
                            <div class="relative" x-data="{ open: false }">
                                <button @click="open = !open; $nextTick(() => { if(open){ $refs.userMenu.focus() } })"
                                    ...
                                    <img class="w-12 h-10 bg-blue-300 rounded-full"
                                        src="{{ url('images/user.jpeg') }}" alt="{{ Auth::user()->name }}" />
                                </button>
                        ...
                        <nav x-transition:enter="transition duration-200 ease-in-out transform sm:duration-500"
                            ...
                            <div class="relative ml-auto" x-data="{ open: false }">
                                <button @click="open = !open" type="button" aria-haspopup="true"
                                    ...
                                    <span class="sr-only">User menu</span>
                                    <img class="w-10 h-10 rounded-full" src="{{ url('images/user.jpeg') }}"
                                        alt="{{ Auth::user()->name }}" />
                                </button>
                        ...
                        <nav aria-label="Main" class="px-2 py-4 space-y-2">
                            ...
                            <div x-data="{ isActive: true, open: false}">
                                ...
                                <a href="/home"
                                    ...
                                    {{-- :class="{'bg-blue-100 dark:bg-blue-600 text-white': isActive }" --}} role="button" aria-haspopup="true"
                            ...
                            <!-- Components links -->
                            <div x-data="{ isActive: false, open: false,  openProcessed:false, }">
                                <!-- active classes 'bg-blue-100 dark:bg-blue-600' -->
                                <a href="" @click="$event.preventDefault(); open = !open"
                                    class="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-blue-100 dark:hover:bg-blue-600 {{ !request()->routeIs('home') ? 'bg-blue-100 dark:bg-blue-600 text-white' : '' }}"
                                    {{-- :class="{ 'bg-blue-100 dark:bg-blue-600 text-white': isActive || open }" --}} role="button" aria-haspopup="true"
                                ...
                                <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Components">
                                    ...
                                    <a @click="$event.preventDefault(); openProcessed = !openProcessed" role="menuitem"
                                        class="flex items-center p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                                        Processed Invoices
                                        <span aria-hidden="true" class="ml-auto">
                                            <!-- active class 'rotate-180' -->
                                            <svg class="w-4 h-4 transition-transform transform"
                                                :class="{ 'rotate-180': openProcessed }"
                                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M19 9l-7 7-7-7" />
